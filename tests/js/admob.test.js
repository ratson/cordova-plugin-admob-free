...
describe('Banner', () => {
  it('prepare() call correct native method', () => {
    ...
    expect(mockFn).toBeCalledWith(
      ...
      'AdMob', 'createBannerView', [expect.objectContaining(options)])
  })
...
describe('Reward Video', () => {
  it('prepare() call correct native method', () => {
    ...
    expect(mockFn).toBeCalledWith(
      expect.any(Function), expect.any(Function),
      'AdMob', 'createRewardVideo', [options])
  })
...
describe('Old APIs', () => {
  ...
  it('prepareInterstitial() should work', () => {
    ...
    expect(mockFn).toBeCalledWith(
      expect.any(Function), expect.any(Function),
      'AdMob', 'prepareInterstitial', [expect.objectContaining(options)])
  })
